...
namespace pedidos.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdCliente,Estado,Total,Fecha")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IdCliente,Estado,Total,Fecha")] Order order)
        {
            if (id != order.Id)
            {
                return NotFound();
